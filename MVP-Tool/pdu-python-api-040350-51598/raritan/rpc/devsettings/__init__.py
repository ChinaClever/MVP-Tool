...
#
# Section generated by IdlC from "Bluetooth.idl"
#
...
class Bluetooth(Interface):
    idlType = "devsettings.Bluetooth:1.0.0"

    # enumeration
    class Antenna(Enumeration):
        idlType = "devsettings.Bluetooth.Antenna:1.0.0"
        values = ["Internal", "External"]

    Antenna.Internal = Antenna(0)
    Antenna.External = Antenna(1)

    # structure
    class Settings(Structure):
        idlType = "devsettings.Bluetooth.Settings:1.0.0"
        elements = ["enabled", "antenna"]

        def __init__(self, enabled=False, antenna=None):
            if antenna is None:
                antenna = raritan.rpc.devsettings.Bluetooth.Antenna.Internal
            typecheck.is_bool(enabled, AssertionError)
            typecheck.is_enum(antenna, raritan.rpc.devsettings.Bluetooth.Antenna, AssertionError)
        ...
        def decode(cls, json, agent, useDefaults=False):
            obj = cls(
                ...
                antenna = raritan.rpc.devsettings.Bluetooth.Antenna.decode(json['antenna']) if 'antenna' in json or not useDefaults else raritan.rpc.devsettings.Bluetooth.Antenna.Internal,
            )
            return obj
        ...
        def encode(self):
            ...
            json['antenna'] = raritan.rpc.devsettings.Bluetooth.Antenna.encode(self.antenna)
            return json

    # value object
    class SettingsChangedEvent(raritan.rpc.event.UserEvent):
        idlType = "devsettings.Bluetooth.SettingsChangedEvent:1.0.0"

        def __init__(self, oldSettings=None, newSettings=None, actUserName="", actIpAddr="", source=None):
            super(raritan.rpc.devsettings.Bluetooth.SettingsChangedEvent, self).__init__(actUserName, actIpAddr, source)
            if oldSettings is None:
                oldSettings = raritan.rpc.devsettings.Bluetooth.Settings()
            if newSettings is None:
                newSettings = raritan.rpc.devsettings.Bluetooth.Settings()
            typecheck.is_struct(oldSettings, raritan.rpc.devsettings.Bluetooth.Settings, AssertionError)
            typecheck.is_struct(newSettings, raritan.rpc.devsettings.Bluetooth.Settings, AssertionError)

            self.oldSettings = oldSettings
            self.newSettings = newSettings

        def encode(self):
            json = super(raritan.rpc.devsettings.Bluetooth.SettingsChangedEvent, self).encode()
            json['oldSettings'] = raritan.rpc.devsettings.Bluetooth.Settings.encode(self.oldSettings)
            json['newSettings'] = raritan.rpc.devsettings.Bluetooth.Settings.encode(self.newSettings)
            return json

        @classmethod
        def decode(cls, json, agent, useDefaults=False):
            obj = cls(
                oldSettings = raritan.rpc.devsettings.Bluetooth.Settings.decode(json['oldSettings'], agent, useDefaults=useDefaults) if 'oldSettings' in json or not useDefaults else raritan.rpc.devsettings.Bluetooth.Settings(),
                newSettings = raritan.rpc.devsettings.Bluetooth.Settings.decode(json['newSettings'], agent, useDefaults=useDefaults) if 'newSettings' in json or not useDefaults else raritan.rpc.devsettings.Bluetooth.Settings(),
                # for event.UserEvent
        ...
        def listElements(self):
            ...
            elements = elements + super(raritan.rpc.devsettings.Bluetooth.SettingsChangedEvent, self).listElements()
            return elements
    ...
    class _getSettings(Interface.Method):
        ...
        def decode(rsp, agent, useDefaults=False):
            _ret_ = raritan.rpc.devsettings.Bluetooth.Settings.decode(rsp['_ret_'], agent, useDefaults=useDefaults)
            typecheck.is_struct(_ret_, raritan.rpc.devsettings.Bluetooth.Settings, DecodeException)
            return _ret_
    ...
    class _setSettings(Interface.Method):
        ...
        @staticmethod
        def encode(settings):
            typecheck.is_struct(settings, raritan.rpc.devsettings.Bluetooth.Settings, AssertionError)
            args = {}
            args['settings'] = raritan.rpc.devsettings.Bluetooth.Settings.encode(settings)
            return args
    ...
    def __init__(self, target, agent):
        super(Bluetooth, self).__init__(target, agent)
        self.getSettings = Bluetooth._getSettings(self)
        self.setSettings = Bluetooth._setSettings(self)

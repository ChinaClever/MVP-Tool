...
class CascadeManager(Interface):
    idlType = "cascading.CascadeManager:3.0.0"
    ...
    class PrimaryUnitSettings(Structure):
        idlType = "cascading.CascadeManager_3_0_0.PrimaryUnitSettings:1.0.0"
    ...
    class Role(Enumeration):
        idlType = "cascading.CascadeManager_3_0_0.Role:1.0.0"
    ...
    class LinkUnitType(Enumeration):
        idlType = "cascading.CascadeManager_3_0_0.LinkUnitType:1.0.0"
        values = ["NETWORK", "SECURE_SERIAL", "ZIGBEE"]

    LinkUnitType.NETWORK = LinkUnitType(0)
    LinkUnitType.SECURE_SERIAL = LinkUnitType(1)
    LinkUnitType.ZIGBEE = LinkUnitType(2)

    # enumeration
    class LinkUnitStatus(Enumeration):
        idlType = "cascading.CascadeManager_3_0_0.LinkUnitStatus:1.0.0"
        values = ["UNKNOWN", "OK", "UNREACHABLE", "ACCESS_DENIED", "FIRMWARE_UPDATE", "FIRMWARE_MISMATCH", "PENDING", "WAITING", "PAIRING_TIMEOUT", "PAIRING"]
    ...
    LinkUnitStatus.WAITING = LinkUnitStatus(7)
    LinkUnitStatus.PAIRING_TIMEOUT = LinkUnitStatus(8)
    LinkUnitStatus.PAIRING = LinkUnitStatus(9)
    LinkUnitStatus._fallback = LinkUnitStatus.UNKNOWN

    # structure
    class LinkUnit(Structure):
        idlType = "cascading.CascadeManager_3_0_0.LinkUnit:1.0.0"
    ...
    class Status(Structure):
        idlType = "cascading.CascadeManager_3_0_0.Status:1.0.0"
        elements = ["role", "primaryUnit", "primaryLinkId", "linkUnits"]

        def __init__(self, role=None, primaryUnit="", primaryLinkId=0, linkUnits={}):
            if role is None:
            ...
            typecheck.is_int(primaryLinkId, AssertionError)

            self.role = role
            self.primaryUnit = primaryUnit
            self.primaryLinkId = primaryLinkId
        ...
        def decode(cls, json, agent, useDefaults=False):
            obj = cls(
                ...
                primaryLinkId = json['primaryLinkId'] if 'primaryLinkId' in json or not useDefaults else 0,
                linkUnits = dict([(
                    elem['key'],
        ...
        def encode(self):
            ...
            json['primaryLinkId'] = self.primaryLinkId
            json['linkUnits'] = [dict(
                key = k,
    ...
    class LinkPortStatus(Structure):
        idlType = "cascading.CascadeManager_3_0_0.LinkPortStatus:1.0.0"
    ...
    class RoleChangedEvent(raritan.rpc.idl.Event):
        idlType = "cascading.CascadeManager_3_0_0.RoleChangedEvent:1.0.0"
    ...
    class LinkUnitAddedEvent(raritan.rpc.event.UserEvent):
        idlType = "cascading.CascadeManager_3_0_0.LinkUnitAddedEvent:1.0.0"
    ...
    class LinkUnitReleasedEvent(raritan.rpc.event.UserEvent):
        idlType = "cascading.CascadeManager_3_0_0.LinkUnitReleasedEvent:1.0.0"
    ...
    class LinkUnitStatusChangedEvent(raritan.rpc.idl.Event):
        idlType = "cascading.CascadeManager_3_0_0.LinkUnitStatusChangedEvent:1.0.0"
    ...
    class LinkPortStatusChangedEvent(raritan.rpc.idl.Event):
        idlType = "cascading.CascadeManager_3_0_0.LinkPortStatusChangedEvent:1.0.0"
    ...
    class _addZigbeeLinkUnit(Interface.Method):
        name = 'addZigbeeLinkUnit'

        @staticmethod
        def encode(linkId, address, installKey):
            typecheck.is_int(linkId, AssertionError)
    ...
    def __init__(self, target, agent):
        ...
        self.addZigbeeLinkUnit = CascadeManager._addZigbeeLinkUnit(self)
